...
qtlenrich_file="../examples/Output_QTLEnrich_example_Mar02_2020/results/QTLEnrich_best_eqtl_50_irnt.gwas.imputed_v3.both_sexes.GRCh38_example_Mar02_2020.txt"
qtlenrich_file2="../examples/Output_QTLEnrich_example_Mar02_2020/results/QTLEnrich_best_sqtl_50_irnt.gwas.imputed_v3.both_sexes.GRCh38_example_Mar02_2020.txt"
label1="eQTL"
label2="sQTL"
gtex_tissue_names_file="../data/gtex_tissue_colors_v8.txt"
exp_label="example"
significant_cutoff=0.025 # Bonferroni correction for testing 1 tissue and two QTL types at alpha=0.05
